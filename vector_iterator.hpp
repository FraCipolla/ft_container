...
public:
    vector_iterator() : elem_(iterator_type()) {}
    explicit vector_iterator(const iterator_type& it) : elem_(it) {}
...
public:
    ...
    vector_iterator operator++(int) { return vector_iterator(elem_++); }
    vector_iterator& operator--()
    {
        --elem_;
        return *this;
    ...
    vector_iterator operator+(difference_type n) const { return vector_iterator(elem_ + n); }
    vector_iterator& operator-=(difference_type n)
    {
        elem_ -= n;
        return *this;
